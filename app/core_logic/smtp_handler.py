...
class SMTPHandler:
    """Handles SMTP operations for the web application, adapted from the desktop script."""
    ...
    def _html_to_text(self, html):
        ...
        try:
            ...
            return "This is an HTML email. Please use a compatible email client."
    ...
    async def send_email_async(self, to_email, subject, html_content, attachments=None, unsubscribe_url=None):
        ...
        is_ssl = self.use_ssl or self.smtp_port == 465
        ...
        try:
            async with aiosmtp.SMTP(
                ...
                if self.use_tls and not is_ssl:
            ...
            log.error(f"Async SMTP Authentication Error for {to_email}: {e}")
